...
/*   Updated: 2022/07/07 18:01:25 by msharifi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_images(t_data *data)
{
	...
	// data->img.exit_l = mlx_xpm_file_to_image(data->mlx,_ptr LOCKED,
	// 		&data->img.width, &data->img.height);
	// data->img.player = mlx_xpm_file_to_image(data->mlx_ptr, PLAYER,
	// 		&data->img.width, &data->img.height);
	// data->img.wall = mlx_xpm_file_to_image(data->mlx_ptr, W_RAND,
	// 		&data->img.width, &data->img.height);
	// data->img.coin1 = mlx_xpm_file_to_image(data->mlx_ptr, COIN1,
	// 		&data->img.width, &data->img.height);
}
